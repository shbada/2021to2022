 ...
 */
public class Tchapter04_게임개발_REDO {
    // 변수 선언
    ...
    public static void main(String[] args) {
        ...
        Tchapter04_게임개발_REDO main = new Tchapter04_게임개발_REDO();
        main.solution();
    }
    ...
    private static void bfs(int x, int y, int direction) {
        ...
        while (true) {
            currentDirection = getDirectionAfterTurn(currentDirection);
            ...
            if (isVisit == 4) {
                ...
                int idx = getDirectionAfterBack(currentDirection);
    ...
    /*
       ...
       direction + 2 % 4;
     */
    private static int getDirectionAfterTurn(int curDir)
    {
        curDir -= 1;
    ...
    /*
       ...
       -> 0(북), 1(동), 2(남), 3(서) 일때 캐릭터가 바라보는 위치가
          0(북) + 2 => 2 = (남)이 되기 때문에
          1(동) + 2 => 3(서)
          2(남) + 2 => 4 % 4 = 0(북)
          3(서) + 2 => 5 % 4 = 1(동)
     */
    private static int getDirectionAfterBack(int curDir)
    {
        curDir += 2; // 2를 더한다.
