 ...
 */
public class Settings1Sync {
    // volatile 키워드
    private static volatile Settings1Sync instance;

    private Settings1Sync() {}
     ...
     * @return
     */
    public static Settings1Sync getInstance() {
        ...
        if (instance == null) {
            // 블록 안에서
            synchronized (Settings1Sync.class) { // Settings1Sync.class 의 Lock 체크
                if (instance == null) {
                    instance = new Settings1Sync();
                }
            }
        }
