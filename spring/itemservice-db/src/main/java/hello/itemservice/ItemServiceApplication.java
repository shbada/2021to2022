...
//@Import(JpaConfig.class) /* JpaConfig 를 설정 파일로 사용 */
//@Import(SpringDataJpaConfig.class) /* SpringDataJpaConfig 를 설정 파일로 사용 */
//@Import(QuerydslConfig.class) /* QuerydslConfig 를 설정 파일로 사용 */
@Import(V2Config.class) /* V2Config 를 설정 파일로 사용 */
