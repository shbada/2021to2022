...
$(function(){
   $("#save").click(function(){
	  ...
	  obj.method = "POST";
	  obj.action = "<c:url value='insertBookSave.do' />";
	  obj.submit();
   });
                               ...
                               <form enctype="multipart/form-data" name="saveFrm">
									<table class="table table-striped b-t text-sm">
					                  ...
					                  <tr>
					                     ...
					                     <td colspan="2"><input type="text" name="pdCg" class="form-control" size="50"/></td>
					                  </tr>
					                  <tr>
					                     <th scope="row">교재명</th>
					                     <td colspan="2"><input type="text" name="pdName" class="form-control" size="50"/></td>
					                  </tr>
					                  <tr>
					                     <th scope="row">교재 가격</th>
					                     <td colspan="2"><input type="text" name="pdPrice" class="form-control" size="20"/></td>
					                  </tr>
					                  <tr>
					                  <th scope="row">교재 설명</th>
					                    <td colspan="2">
					                     <textarea rows="10" cols="110" name="pdInfo" class="form-control" ></textarea>
					                    </td>
					                  </tr>
					                  <tr>
					                     <th scope="row">이미지</th>
