...
function listMemberDetail(idx){ 
	document.viewTable.reqNo.value = idx; //freeBorIdx에 받아온 게시글번호 idx값을 담음
	document.viewTable.method="POST";   		
	document.viewTable.action="<c:url value='/oneMemberDetail.do' />"; //컨트롤러로 이동!	
...
function listDetail(idx){ 
	...
	document.viewTable.method="POST";   		
	document.viewTable.action="<c:url value='/oneAdminDetail.do' />"; //컨트롤러로 이동!	
	document.viewTable.submit();
}
